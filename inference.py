...
sys.path.append("/share/home/yxchen/github/petcttools/lucid/")
from datautils import resampleVolume,adjust_image_direction
sys.path.append("/share/home/yxchen/08TripleUniversalModel/")
from SPC import SPC
...
def inference(ct_path,output_seg_path,output_stdct_path=None,check=True,modelname=None,dataset_mapping_to_model=None):
    '''
    ...
    # lesionclip = torch.load("../lesionclip_RN101.pth").to("cuda:0")
    print(config)
    model = SPC(config,tissueclip,1)
